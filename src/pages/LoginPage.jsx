  ...
  return (
    <div className="login-page">
      ...
      <div className="login-card glass">
        <div className="login-logo">WELL<span>STREAMER</span></div>
        ...
        <div className="field">
          ...
          <input className="field-input" placeholder="your_username" value={username} onChange={e => setUsername(e.target.value)} onKeyDown={onKey} autoComplete="username" autoFocus />
        </div>
        <div className="field">
          <label className="field-label">Password</label>
          <input className="field-input" type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={onKey} autoComplete={tab === 'register' ? 'new-password' : 'current-password'} />
        </div>
